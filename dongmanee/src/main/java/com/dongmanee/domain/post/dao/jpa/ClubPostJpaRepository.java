...
public interface ClubPostJpaRepository extends JpaRepository<Post, Long>, ClubPostRepository {

	@Query(
		"SELECT DISTINCT p FROM Post p LEFT JOIN FETCH p.category LEFT JOIN FETCH p.category.club LEFT JOIN FETCH p.member "
